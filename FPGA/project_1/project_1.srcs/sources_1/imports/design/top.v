module DIF_R2SDF_top #(
    ...
    //
    // Stage 4 already naturally produces the final FFT samples
    // over two consecutive cycles:
    //
    // st4_valid = 1:
    //      output Stage-4 butterfly SUM
    //
    // following cycle:
    //      output Stage-4 SR1 output
    //      which contains the previous butterfly DIFF
    //
    // Therefore no separate serializer is required.
    // =========================================================


    // ---------------------------------------------------------
    // Delay Stage-4 valid by one clock.
    //
    // st4_valid_d indicates that the current SR1 output
    // corresponds to the previous valid butterfly DIFF.
    // ---------------------------------------------------------
