...
HD_PWD='D:/fft_fpga/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DIF_R2SDF_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DIF_R2SDF_top.tcl -notrace
