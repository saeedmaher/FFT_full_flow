...
HD_PWD='D:/fft_fpga/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DIF_R2SDF_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DIF_R2SDF_top.tcl
